    ...
    return (
        <div className="row center custom-container">
                ...
                <div className="left-overlay">
                    <div className="name">
                        <div className="py-5 px-3">
                            <div className="h4 font-weight-bold d-inline-block">
                                Ansuman Ghosh
                            </div>
                    ...
                    <div className="about py-5 px-3 text-justify">
                        <p className="mb-5">
                            Fullstack Developer with 8 years of experience who
                            loves to work with Python, JavaScript and Go.
                        </p>
                    </div>
                    <div className="contact py-5 px-3 text-justify">
                        <div className="mb-3 d-block">
                            <span className="material-icons align-middle contact-icon">
                                location_city
                            </span>
                            <span className="ml-2 align-middle contact-text">
                        ...
                        <div className="mr-4 d-inline-block">
                            ...
                            <span className="ml-2 align-middle contact-text contact-color">
            ...
            <div
                className={
                    theme
                        ? 'col-lg-6 right-section theme-light'
                        : 'col-lg-6 right-section theme-dark'
                }
            >
                <span
                    className="material-icons theme-switch"
                ...
                <div className="container my-5">
                    <div className="section">
                        ...
                        <blockquote className="blockquote section-text">
                            <p className="mx-3 pb-2 border-bottom">
                                Python, Javascript(Node.js), Go, React, sql,
                                HTML, css
                            </p>
                        </blockquote>
                    </div>
                    ...
                    <div className="section">
                        ...
                        <blockquote className="blockquote section-text">
                            <p className="mx-3 pb-2 border-bottom">
                                B.Tech (EE) in Asansol Engineering College
                                (WBUT) from 2008 to 2012
                            </p>
                        </blockquote>
                    </div>
                    <div className="section">
                    ...
                    <div className="follow row p-0 m-0">
                        <div className="col m-0 p-0">
                            <a
                                href="https://github.com/ansu5555/"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <img
                        ...
                        <div className="col m-0 p-0">
                            <a
                                href="https://twitter.com/ansu5555"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <img
                        ...
                        <div className="col m-0 p-0">
                            <a
                                href="https://www.instagram.com/ansumanghosh/"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <img
